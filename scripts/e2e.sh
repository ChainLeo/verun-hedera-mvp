...
echo "$x402_body" | grep -q '"maxAmountRequired":"50000"' && pass "USDC amount: 50000 micro-USDC (0.05)" || fail "USDC amount wrong"
echo "$x402_body" | grep -q '"maxAmountRequired":"5000000"' && pass "HBAR amount: 5000000 tinybars (0.05)" || fail "HBAR amount wrong"
