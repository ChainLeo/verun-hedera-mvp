...
echo "$x402_body" | grep -q '"maxAmountRequired":"10000"' && pass "USDC amount: 10000 micro-USDC (0.01)" || fail "USDC amount wrong"
echo "$x402_body" | grep -q '"maxAmountRequired":"1000000"' && pass "HBAR amount: 1000000 tinybars (0.01)" || fail "HBAR amount wrong"
